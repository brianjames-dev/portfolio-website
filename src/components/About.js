  ...
  return (
    <section id="about" className="about" data-snap-target>
      <div className="container about-card">
        ...
        I'm a creative and detail-oriented developer who finds joy and fufillment in the complexities of code. 
        ...
        Mostly, I learned the strength of adaptaibility, and the ways in which remaining positive (and leaning on humor) would help me navigate difficult situations.
